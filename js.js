...
/**
 * Testfunktion: Gemmer de tre opgaver fra screenshot i localStorage.
 * Kør seedTasks() fra konsollen for at teste, eller fjern kommentaren for at køre automatisk.
 */
function seedTasks() {
    saveTasks([
        { id: generateGUID(), text: "Luk altan dør", completed: false },
        { id: generateGUID(), text: "Sluk Glatte jern", completed: false },
        { id: generateGUID(), text: "Husk Nøgler", completed: false }
    ]);
}
...
const homeIconSrc = 'home-svgrepo-com.svg';
